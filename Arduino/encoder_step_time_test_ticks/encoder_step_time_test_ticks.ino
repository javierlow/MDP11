...
Serial.println("LABEL,Time,Timer,Sample Number,Sample Time,E1 Ticks, E2 Ticks"); //always write LABEL, so excel knows the next things will be the names of the columns (instead of Acolumn you could write Time for instance)
