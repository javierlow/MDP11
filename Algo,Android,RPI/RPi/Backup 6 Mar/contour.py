...
def getImageLocation(sampleImg, actualImage):
    ...
    for (i, c) in enumerate(cnts):
        ...
        # conditional check if contour matches any of the conditions we are looking for, we append the distance 
        # and location condition: 6-8 edges; matches given shape up to 0.25 likeliness; object to image area 
        # ratio
...
def main():
    ...
    img = cv2.imread('/rpi/opencv/testbed/arrow_test.jpg', cv2.IMREAD_GRAYSCALE)
    # read image
    capturedImage = cv2.imread('/home/pi/Desktop/testt.jpg', cv2.IMREAD_UNCHANGED)
    # image preprocessing
