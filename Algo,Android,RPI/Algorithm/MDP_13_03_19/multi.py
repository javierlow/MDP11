...
class Main(threading.Thread):
    ...
    def __init__(self):
        ...
        # self.bluetooth_thread = BT_Connector()
        ...
        # self.bluetooth_thread.Connect_BT()
    ...
    def send_to_bluetooth(self, msg_to_bt):
        ...
        if self.bluetooth_thread.BT_connect() and msg_to_bt:
            msg_to_bt_str = msg_to_bt.decode('ascii')
            self.bluetooth_thread.sendMess_BT(msg_to_bt_str)
    ...
    def receive_from_bluetooth(self):
        ...
        while True:
            ...
            read_bt_msg = self.bluetooth_thread.rcvMess_BT()

            if self.bluetooth_thread.BT_connect() and read_bt_msg:
    ...
    def close_all_sockets(self):
        ...
        # self.bluetooth_thread.close_bt()
